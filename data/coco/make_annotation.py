...
orig_path = '/PATH/TO/COCO'  # insert here the source path where original COCO annotations are
dest_path = '/PATH/TO/COCO'  # the destination folder, which should be this one'
