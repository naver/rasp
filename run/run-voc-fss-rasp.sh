...
# some examples:
# bash run/run-voc-fss-rasp.sh 0 5-0 rasp-fss
# bash run/run-voc-fss-rasp.sh 0 5-1 rasp-fss

# for running on slurm:
# sbatch run/run-voc-fss-rasp.sh 0 5-2 rasp-fss
