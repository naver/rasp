...
# $4 name of the exp. e.g. WILSON
# $5 number of WS incremental steps. e.g., 1 for task 15-5, 5 for task 15-1, etc

# some examples:
# bash run/run-voc-wilson.sh 0,1 0 15-5 wilson 1
# bash run/run-voc-wilson.sh 0,1 1 10-5-5 wilson 2

# for running on slurm:
# sbatch run/run-voc-wilson.sh 0,1 0 15-5 wilson 1
