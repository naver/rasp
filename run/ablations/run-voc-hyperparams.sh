...
# $6 weight of the semantic prior loss. e.g. 0.1/1/10, etc
# $7 value of tau, the dampening co-efficient. e.g. 1/5/10 etc
# $8 similarity type. e.g. transformer/glove/etc

# some examples:
# bash run/run-voc-rasp.sh 0,1 0 15-5 RaSP-glove 1 1 5 glove
# bash run/run-voc-rasp.sh 0,1 1 10-5-5 RaSP-tree 2 1 2 tree

# for running on slurm:
# sbatch run/run-voc-rasp.sh 0,1 0 10-2 RaSP 5 1 5 transformer
